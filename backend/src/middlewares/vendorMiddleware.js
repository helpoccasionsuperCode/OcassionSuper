...
const handleVendorUploads = async (req, res, next) => {
    try {
        ...
        // Attach to body so validator and controller see them
        // if (imageUrls.length) req.body.images = imageUrls;
        // if (videoUrls.length) req.body.videos = videoUrls;
        // req.body.documents = {
        //     gst: gstUrls.length ? gstUrls : null,
        //     businessProof: businessProofUrls.length ? businessProofUrls : null,
        //     idProof: idProofUrls.length ? idProofUrls : null,
        // };

        // req.body.documents = {
        //     gst: gstUrls.length ? gstUrls : req.body.documents?.gst ?? null,
        //     businessProof: businessProofUrls.length ? businessProofUrls : req.body.documents?.businessProof ?? null,
        //     idProof: idProofUrls.length ? idProofUrls : req.body.documents?.idProof ?? null,
        // };
