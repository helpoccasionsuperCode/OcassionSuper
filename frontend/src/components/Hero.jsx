        ...
        <section className="relative w-full bg-white p-8">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-7">
                    ...
                    {/* CTA Buttons */}
                    <div className="flex gap-4">
                        <button className="px-6 py-3 text-xl rounded-lg cursor-pointer bg-gradient-to-r from-[#c37a61] via-[#e29177] to-[#367d80] text-white font-medium shadow-md hover:scale-105 transition"
                            onClick={() => navigate("/event-planning")} >

                            Start AI Planning
                        </button>
                        <button className="px-6 py-3 text-xl cursor-pointer rounded-lg border border-[#E69B83] text-[#E69B83] font-medium hover:bg-[#E69B83] hover:text-white transition"
